...
for l in ll:
    ...
    for num in range(a, b+1):
        for k in range(1,6):
            if 10**(k*2-1) <= num <= 10**(k*2)-1 and num//(10**k)==num%(10**k):
                sum_invalid_a += num
        if repeating_pattern(num):
            sum_invalid_b += num         

print('part 1:', sum_invalid_a)
print('part 2:', sum_invalid_b)